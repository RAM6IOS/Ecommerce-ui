...
import 'package:ecommerce_ui/controler/Auth/ForgetPassword/CodeVerificationControler.dart';
...
const CodeVerification({ Key? key }) : super(key: key);
  ...
  Widget build(BuildContext context){
    CodeVerificationControler controler = Get.put(CodeVerificationControler());
    return Scaffold(
      appBar: AppBar(
